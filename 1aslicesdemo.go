...
func main() {
	...
	//of elements). To create an empty slice with non-zero length, use the builtin make. Here we make a slice of strings of length 3 (initially zero-valued).
	s := make([]string, 3)
	fmt.Println("emp:", s)
	...
	/*
		...
		fmt.Println("cpy2:", c)
	*/
	//Slices support a “slice” operator with the syntax sliceName[low:high]. For example,
