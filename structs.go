...
func newPerson(Name string) *Person {
	...
	//	You can return a pointer to local variable as a local variable will survive the
...
func main() {
	...
	*/
	...
	p6 := Person{Name: "Sean", Type: "employee", subject: "Python"}
	fmt.Println(p6.Name)
	...
	op2 := &p6
	fmt.Println(op2.Type)

	//	It’s idiomatic to encapsulate new struct creation in constructor functions
	//look at newPerson "constructor" function above
	/*
		np := newPerson("John")
		fmt.Println(np)
		fmt.Println(&np)
